  ...
  <%@ taglib prefix="c" uri="jakarta.tags.core" %>
    <%@ page isELIgnored="false" %>
      ...
      <head>
        ...
        <!-- Linking Index.css for styling and using Expression Language for dynamic context path -->
      ...
      <section>
       ...
       <!--Adding hamburger menu for the mobile navigations-->
       ...
       <path d="M0 0H27.65V5.219H0V0ZM0 9.39H27.65V14.609H0V9.39ZM0 18.781H27.65V24H0V18.781Z" fill="black"/>
       </svg>
                     </button>
                   </div>
                 </nav>
