        ...
        <header>
          <nav>
            ...
            <ul class="nav_links" id="nav-links">
              ...
              <!-- Mobile Auth Buttons (Displayed only within the hamburger menu on smaller screens) -->
              ...
              <div class="deal_panel" id="panel-corolla">
                ...
                <div class="deal_info">
                  ...
                  <div class="deal_price_row">
                    ...
                    <a href="<%= request.getContextPath() %>/rentalDeals" class="button" ${v.vehicle_status
                      !='Available' ? 'style="pointer-events: none; opacity: 0.6;"' : '' }>
                      Book Now
                    </a>
                  </div>
                </div>
          ...
          <div class="client_grid">
            <div class="client_card">
              <div class="client_details">
                <img src="<%= request.getContextPath() %>/Assets/images.jpeg" alt="Kushal Khanal"
                  class="client_avatar" />
                <div>
                  <h4>Kushal Khanal</h4>
            ...
            <div class="client_card">
              <div class="client_details">
                <img src="<%= request.getContextPath() %>/Assets/images.jpeg" alt="Rehan Basnet"
                  class="client_avatar" />
                <div>
                  <h4>Rehan Basnet</h4>
                  <div class="client_rating">
            ...
            <div class="client_card">
              <div class="client_details">
                <img src="<%= request.getContextPath() %>/Assets/images.jpeg" alt="Rojal Shrestha"
                  class="client_avatar" />
                <div>
              ...
              <p>Excellent vehicles and very professional staff. The booking process was quick and the car was in
                perfect
                condition.</p>
            </div>
          </div>
