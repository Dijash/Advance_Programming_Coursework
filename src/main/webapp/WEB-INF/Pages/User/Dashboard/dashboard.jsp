  ...
  <main>
    ...
    <header class="top-navbar">
      ...
      <div class="welcome-text">
        <h1>
          Hello,
          <c:out value="${sessionScope.user.customer_username}" default="Driver" />
        </h1>
            ...
            <tbody>
              <c:forEach var="booking" items="${userRecentBookings}">
                ...
                <tr>
                  ...
                  <td>
                    <%-- Status indicator with color coding and glow effect --%>
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                      ...
                      <c:if test="${booking.status == 'Pending'}">
                        <form action="${pageContext.request.contextPath}/cancelBooking" method="POST"
                          style="margin: 0;" onsubmit="return confirm('Cancel this booking?')">
                          <input type="hidden" name="bookingId" value="${booking.bookingId}">
                          <button type="submit" class="btn-action"
                            style="color: var(--danger); border-color: #fca5a5; background: #fff1f1; cursor: pointer;">
                            Cancel
                          </button>
                        </form>
                      </c:if>
              ...
              <%-- Empty state when no recent bookings --%>
