    ...
    <body>
      ...
      <main>
        ...
        <div class="page-container">
          ...
          <%-- Content box containing customer profile --%>
          <div class="content-box">
            <%-- Profile top section with avatar and basic info --%>
            <div class="profile-top">
              <%-- Customer avatar circle showing initials --%>
              ...
              <div class="user-info-main">
                ...
                <p>User ID: <strong>#${customer.customer_id}</strong> | <span
                    class="username-badge">@${customer.customer_username}</span></p>
              </div>
            ...
            <%-- Detail grid displaying customer information --%>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <form action="${pageContext.request.contextPath}/deleteCustomer" method="POST"
              ...
              <button type="submit" class="btn-delete-confirm" style="border: none; cursor: pointer;">Yes,
                Delete</button>
            </form>
          </div>
        </div>
