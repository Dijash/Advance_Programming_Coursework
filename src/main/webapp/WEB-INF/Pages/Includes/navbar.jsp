        ...
        <header style="background: white; border-bottom: 1px solid #e2e8f0;">
          ...
          <nav>
            ...
            <ul class="nav_links" id="nav-links">
              <%-- Rental Deals link --%>
              <li><a href="${pageContext.request.contextPath}/rentalDeals"
                  class="${activePage == 'rentalDeals' ? 'active' : ''}">Rental Deals</a></li>
              <%-- About link --%>
              <li><a href="${pageContext.request.contextPath}/about"
                  class="${activePage == 'about' ? 'active' : ''}">About</a></li>
              <%-- Contact Us link --%>
              <li><a href="${pageContext.request.contextPath}/contact"
                  class="${activePage == 'contact' ? 'active' : ''}">Contact Us</a></li>
            </ul>
                ...
                <c:when test="${not empty sessionScope.user}">
                  ...
                  <div class="user_avatar_wrap">
                    ...
                    <label for="userDropdownToggle"
                      ...
                      <%-- User avatar with image or default icon --%>
