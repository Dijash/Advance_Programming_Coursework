  ...
  <section class="contact_wrapper">
      ...
      <div class="contact_card">
        <div class="contact_icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em"
            fill="currentColor">
            <path
              d="M9.36556 10.6829C10.3023 12.3303 11.6696 13.6976 13.3169 14.6343L14.207 13.3882C14.4754 13.0125 14.9669 12.8617 15.4116 13.0189L19.5392 14.4789C20.0888 14.6734 20.4578 15.1955 20.4542 15.7797C20.4191 21.4392 15.6888 21.9961 12 22C6.18206 22.0068 2 17.8184 2 12C2.00392 8.31135 2.56073 3.58087 8.22026 3.54578C8.80436 3.54226 9.32653 3.91118 9.52103 4.46081L10.981 8.58828C11.1382 9.03303 10.9874 9.52453 10.6117 9.79289L9.36556 10.6829ZM7.44755 11.9686L9.12328 10.795L8.03716 7.72464C5.00624 8.21208 4.02062 10.8874 4 12C3.98592 16.7138 7.28616 20.014 12 20C13.1124 19.9793 15.7876 18.9937 16.2752 15.9627L13.2048 14.8766L12.0312 16.5524C11.6884 17.0321 11.0258 17.1594 10.5199 16.8524C8.44199 15.5907 6.40916 13.5579 5.1475 11.48C4.84047 10.9741 4.96783 10.3114 5.44755 9.96864V11.9686Z">
            </path>
          </svg>
        </div>
        <div>
    ...
    <div class="contact_form_container">
      ...
      <c:if test="${param.status == 'success'}">
        <div
          style="background: #d1fae5; color: #065f46; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; border: 1px solid #34d399; font-weight: 500;">
      ...
      <c:if test="${param.status == 'error'}">
        <div
          style="background: #fee2e2; color: #b91c1c; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; border: 1px solid #fca5a5; font-weight: 500;">
