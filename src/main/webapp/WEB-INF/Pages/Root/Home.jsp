                              ...
                              <div id="unsubscribeModal" class="modal-overlay">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p>Are you sure you want to unsubscribe from our newsletter? You will no longer
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <form action="${pageContext.request.contextPath}/subscribe" method="post"
                                      ...
                                      <button type="submit" class="btn-delete-confirm"
                                        style="border: none; cursor: pointer;">Yes, Unsubscribe</button>
                                    </form>
                                  </div>
                                </div>
                              </div>
                          ...
                          <c:otherwise>
                            <%-- User is not subscribed — show subscribe form --%>
                              <form action="${pageContext.request.contextPath}/subscribe" method="post"
                                ...
                                <input type="email" name="email" value="${sessionScope.user.customer_email}"
                                ...
                                <c:choose>
                                  <c:when test="${not empty review.customerImage}">
                                    <img
                                      ...
                                      alt="<c:out value='${review.customerName}' />" class="client_avatar" />
                                  </c:when>
                                  <c:otherwise>
                                ...
                                <div>
                                  ...
                                  <div class="client_rating">
                                    <c:forEach begin="1" end="5">
                                      <svg class="star-fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="currentColor">
                                    </c:forEach>
                                  </div>
