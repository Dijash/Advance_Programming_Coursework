...
<%
    // Fetch logged-in user details for the Navigation Bar
    ...
    <div class="section_container footer_container">
      ...
      <div class="footer_col">
        ...
        <ul class="footer_links">
          ...
          <li><a href="<%= request.getContextPath() %>/#deals">Rental Deals</a></li>
          <li><a href="<%= request.getContextPath() %>/#choose">Why Choose Us</a></li>
          <li><a href="<%= request.getContextPath() %>/client">Testimonials</a></li>
        </ul>
      </div>
      <div class="footer_col">
