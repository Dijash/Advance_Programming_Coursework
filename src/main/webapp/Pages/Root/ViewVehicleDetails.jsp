          ...
          <header>
            <nav>
              <div class="nav_header">
                <div class="nav_logo">
                  <a href="${pageContext.request.contextPath}${not empty sessionScope.user ? '/home' : '/'}"
                    class="logo">
                    <span>RentAll</span>
                  </a>
                </div>
                    ...
                    <div class="user_avatar_wrap" id="userAvatarWrap">
                      ...
                      <div class="user_dropdown" id="userDropdown">
                        <div class="dropdown_header">
                          <p>${not empty sessionScope.user.first_name ? sessionScope.user.first_name : 'User'}
                            ${sessionScope.user.last_name}</p>
          ...
          <div style="background: var(--bg);">
            <main class="container">
              <div style="margin-bottom: 2rem; color: #64748b; font-size: 0.9rem; font-weight: 500;">
                ...
                <span style="margin: 0 0.5rem;">/</span> <span style="color: #0f172a;">${vehicle.vehicle_brand}
