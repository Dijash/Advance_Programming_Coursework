            ...
            <head>
              ...
              <style>
                ...
                * {
                ...
                /* UPDATED Full Image Modal Styles */
                .modal-overlay {
                  display: none;
                  position: fixed;
                  top: 0;
                      ...
                      <div class="notif-dropdown" id="notifMenu">
                        <c:forEach var="n" items="${recentNotifications.rows}">
                          <div class="notif-item">
                            <strong>${n.notification_type}</strong><br>${n.notification_description}
                          </div>
                        </c:forEach>
                      </div>
                    </div>
                  ...
                  <form action="<%= request.getContextPath() %>/updateProfile" method="POST" class="profile-card"
                    ...
                    <div class="profile-body">
                        ...
                        <div class="summary-avatar-wrap" id="openModalBtn" title="Click to view full image">
                          <c:choose>
                            <c:when test="${not empty sessionScope.user.customer_image}">
                              <img
                                src="<%= request.getContextPath() %>/Assets/Profiles/${sessionScope.user.customer_image}"
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="username" class="info-box"
                          value="${sessionScope.user.customer_username}" required>
                      </div>
                      <div class="form-group">
                        <label>New Password</label>
                        <input type="password" name="password" class="info-box"
