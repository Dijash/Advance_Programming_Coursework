...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .content-box { background: var(--card-bg); border-radius: var(--radius-lg); padding: 2.5rem; box-shadow: var(--shadow); border: 1px solid var(--border); }
    ...
    .details-section { background: var(--bg-main); padding: 1.75rem; border-radius: var(--radius-md); border: 1px solid var(--border); }
    .details-section h3 { font-size: 1.1rem; color: var(--primary); margin-bottom: 1.5rem; font-weight: 700; }
    .detail-row { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem; border-bottom: 1px dashed #cbd5e1; padding-bottom: 0.75rem; }
    ...
    .btn-cancel-large { background: #fff1f1; color: var(--danger); border: 1px solid #fca5a5; padding: 0.75rem 2rem; border-radius: var(--radius-md); font-weight: 700; cursor: pointer; transition: 0.3s; text-transform: uppercase; letter-spacing: 1px; }
    ...
    <div class="dashboard-content">
      ...
      <section class="content-box">
        <div class="booking-header">
          ...
          <div class="status-text" style="color: ${bookingDetails.status == 'On Track' ? '#10b981' : (bookingDetails.status == 'Cancelled' ? '#ef4444' : '#64748b')}; text-shadow: 0 0 15px ${bookingDetails.status == 'On Track' ? 'rgba(16,185,129,0.2)' : 'transparent'};">
